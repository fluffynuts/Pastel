...
namespace Pastel.Tests
{
    ...
    public class ColorTests
    {
        public class ForegroundColor
        {
            ...
            public void Given_Specified_RGB_Color_And_Input_String_Should_Return_Specified_String(
                int red,
                int green,
                int blue,
                string inputString,
                string expectedAnsiColorString
            )
            {
            ...
            public void Given_Specified_Hex_Color_String_And_Input_String_Should_Return_Specified_String(
                string hexColor,
                string inputString,
                string expectedAnsiColorString
            )
            ...
            [InlineData("aaaaaa", "input", "\u001b[38;2;170;170;170minput\u001b[0m")]
            public void
                Given_Specified_Hex_Color_String_Without_A_Leading_Number_Sign_And_Input_String_Should_Return_Specified_String(
                    string hexColor,
                    string inputString,
                    string expectedAnsiColorString
                )
            ...
            [Fact]
            public void
                A_Given_Hex_Color_String_Should_Return_Same_Ansi_Output_String_Irrespective_Of_Being_Preceded_By_A_Number_Sign()
            {
            ...
            [InlineData("abaBAB")]
            [InlineData("ABABAB")]
            public void A_Given_Hex_Color_String_Should_Return_Same_Ansi_Output_String_Irrespective_Of_Case(
                string hexColor
            )
            {
                const string inputString = "input";
        ...
        public class NestedColor
        {
            ...
            public void A_Nested_Color_String_Must_Be_Correctly_Closed()
            {
                ...
                var output =
                    $"a{"b".Pastel(Color.FromArgb(red2, green2, blue2))}c".Pastel(Color.FromArgb(red1, green1, blue1));

                Assert.Equal(
                    "\u001b[38;2;1;1;1ma\u001b[0m\u001b[38;2;2;2;2mb\u001b[0m\u001b[38;2;1;1;1mc\u001b[0m",
                    output
                );
            }
            ...
            {
                var outputAnsiColorString =
                    $"{$"START_{"[TEST]".Pastel(Color.Yellow).PastelBg(Color.Crimson)}_END".Pastel(Color.DeepPink)}";


                Assert.Equal(
                    "\u001b[38;2;255;20;147mSTART_\u001b[0m\u001b[38;2;255;20;147m\u001b[48;2;220;20;60m\u001b[38;2;255;255;0m[TEST]\u001b[0m\u001b[38;2;255;20;147m_END\u001b[0m",
                    outputAnsiColorString
                );
            }
        }
        ...
        public class NoOutputColor
        {
            ...
            private static void ColorOutputEnabledTest(
                string expectedAnsiColorCodePart,
                string outputAnsiColorString1,
                string outputAnsiColorString2
            )
            {
            ...
            public void Output_Should_Honor_Current_State_When_Switching_Between_States_ConsoleColor(
                ConsoleColor color,
                string expectedAnsiColorCodePart
            )
            {
